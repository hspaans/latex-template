...
\lstinputlisting[language=ksh,basicstyle=\small\ttfamily,breaklines=true,showtabs=false,showspaces=false,breakatwhitespace=true,caption={Listing Caption},captionpos=b]{.editorconfig}
